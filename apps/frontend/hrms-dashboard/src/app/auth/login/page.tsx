        ...
        >
          <Card>
            <CardHeader className="text-center">
              ...
              >
                <div className="mx-auto mb-4 h-12 w-12 rounded-xl bg-primary/20 flex items-center justify-center border border-primary/20">
                  <svg
                ...
                <CardDescription>
                  Sign in to manage employees, teams, and access
                </CardDescription>
              </motion.div>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="flex flex-col space-y-2 text-center text-sm text-muted-foreground">
              <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground/50">Sentra HRMS</p>
            </CardFooter>
          </Card>
        </motion.div>
      </div>
