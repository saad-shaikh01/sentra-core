...
export function DetailSheet({ open, onClose, title, description, children, action }: DetailSheetProps) {
  return (
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6 space-y-6 overscroll-contain">
              {children}
            </div>
          </motion.div>
        </>
