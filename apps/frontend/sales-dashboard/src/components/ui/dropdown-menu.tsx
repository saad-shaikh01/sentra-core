...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'transition-colors duration-150 focus:bg-white/10 data-[state=open]:bg-white/10',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-lg border border-white/10 bg-white/5 p-1 text-foreground shadow-xl shadow-black/20 backdrop-blur-xl',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'transition-colors duration-150 focus:bg-white/10 focus:text-foreground',
