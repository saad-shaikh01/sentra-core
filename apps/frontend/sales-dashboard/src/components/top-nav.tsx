...
export function TopNav() {
  ...
  return (
    <>
      ...
      <header className="h-20 border-b border-border bg-background/20 backdrop-blur-xl flex items-center justify-between px-4 md:px-8 sticky top-0 z-40">
        <div className="flex items-center gap-2 md:gap-4">
          <Button
            variant="ghost"
            size="icon"
            onClick={toggleSidebar}
            className="lg:hidden h-10 w-10 hover:bg-accent/10"
          >
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          <button
            ...
            className="relative group flex items-center justify-center md:justify-start w-10 h-10 md:w-80 md:h-10 md:pl-10 md:pr-3 bg-muted/30 border border-border rounded-xl text-sm text-muted-foreground hover:bg-muted/50 hover:border-primary/30 transition-all"
          >
            ...
            <div className="hidden md:flex items-center gap-1 px-1.5 py-0.5 rounded border border-border bg-background/5 text-[10px] font-bold">
