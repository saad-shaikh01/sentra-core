...
export const RBAC_PERMISSIONS: SeedPermission[] = [
  ...
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:leads:claim', label: 'Claim Leads' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:leads:collaborate', label: 'Collaborate on Leads' },
  {
    appCode: AppCode.SALES_DASHBOARD,
    code: 'sales:leads:notify_signup',
    label: 'Receive Signup Lead Notifications',
    description: 'Receive notifications when signup leads are captured for your team.',
  },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:leads:convert', label: 'Convert Leads' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:leads:import', label: 'Import Leads' },
  ...
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:sales:charge', label: 'Charge Sales' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:sales:note', label: 'Add Sales Notes' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:sales:contract', label: 'Manage Sale Contracts' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:invoices:view', label: 'View Invoices' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:invoices:create', label: 'Create Invoices' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:invoices:edit', label: 'Edit Invoices' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:invoices:delete', label: 'Delete Invoices' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:invoices:pay', label: 'Pay Invoices' },
  ...
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:view_own', label: 'View Own Clients' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:view_all', label: 'View All Clients' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:create', label: 'Create Clients' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:edit', label: 'Edit Clients' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:delete', label: 'Delete Clients' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:assign', label: 'Assign Clients' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:note', label: 'Add Client Notes' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:portal', label: 'Manage Client Portal' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:clients:status', label: 'Update Client Status' },
  // Page-visibility permissions — control which sidebar pages a role can see
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:leads',    label: 'Show Leads Page' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:clients',  label: 'Show Clients Page' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:sales',    label: 'Show Sales Page' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:invoices', label: 'Show Invoices Page' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:packages', label: 'Show Packages Page' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:teams',    label: 'Show Teams Page' },
  { appCode: AppCode.SALES_DASHBOARD, code: 'sales:page:settings', label: 'Show Settings Pages (Gmail / G Suite)' },
...
export const RBAC_SYSTEM_ROLES: SeedRole[] = [
  {
    ...
    permissions: [
      ...
      'sales:clients:view_own',
      'sales:clients:view_all',
      'sales:clients:create',
      'sales:clients:edit',
      'sales:clients:delete',
      'sales:clients:assign',
      'sales:clients:note',
      'sales:clients:portal',
  ...
  {
    appCode: AppCode.SALES_DASHBOARD,
    slug: 'sales_project_manager',
    name: 'Sales Project Manager',
    permissions: [
      'sales:sales:view_all',
      'sales:sales:create',
      'sales:sales:note',
